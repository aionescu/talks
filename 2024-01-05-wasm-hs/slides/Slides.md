...
* We've seen how to embed WebAssembly in Haskell
* We used type-level techniques to make the DSL type-safe
  * GADTs, HLists, WithDict
* We used continuation-passing style for efficient interpretation
* We overloaded Haskell's syntax to _make it look like WebAssembly_
  * `RebindanbleSyntax`, `OverloadedLabels`
...
Please leave a ⭐ if you like the project!
